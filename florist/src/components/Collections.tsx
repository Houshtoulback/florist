...
export default function Collections() {
  return (
    <div
      ...
      style={bgGradient}
    >
      <CollectionItem image='assets/images/cactus.jpg' title='cactus' />
      <CollectionItem image='assets/images/bonsai.jpg' title='bonsai' />
      <CollectionItem image='assets/images/succulent.jpg' title='succulent' />
      <CollectionItem
        image='assets/images/indoorPlants.jpg'
        title='indoor plants'
      />
    </div>
  );
